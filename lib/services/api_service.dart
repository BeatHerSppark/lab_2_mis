...
class ApiService {
  ...
  static Future<List<MealBrief>> fetchMealsByCategory(String category) async {
    ...
    if (resp.statusCode == 200) {
      ...
      return meals.map((e) => MealBrief.fromJson(e as Map<String, dynamic>)).toList();
    }
    throw Exception('Failed to load meals for category');
  }


  static Future<List<MealBrief>> searchMeals(String query) async {
